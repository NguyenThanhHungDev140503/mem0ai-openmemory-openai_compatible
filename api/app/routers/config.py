...
class LLMConfig(BaseModel):
    ...
    openai_base_url: Optional[str] = Field(None, description="Custom base URL for OpenAI-compatible LLM APIs (e.g., Minimax, Chutes)")
...
class EmbedderConfig(BaseModel):
    ...
    api_key: Optional[str] = Field(None, description="API key or 'env:API_KEY' to use environment variable")
    ollama_base_url: Optional[str] = Field(None, description="Base URL for Ollama server (e.g., http://host.docker.internal:11434)")
    openai_base_url: Optional[str] = Field(None, description="Custom base URL for Embedder APIs (e.g., OpenRouter, Minimax)")
